...
_PUBLIC_REPO_ERROR = (
    "Refusing to save: the target repository is not private. Goo Buddy backups "
...
_UNKNOWN_VISIBILITY_ERROR = (
    ...
    "Goo Buddy backups contain credentials and must never go to a public or "
...
async def save_config(
    ...
    The target repository must be private — Goo Buddy backups carry MQTT
