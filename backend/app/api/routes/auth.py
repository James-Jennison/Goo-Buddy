...
async def test_smtp_connection(
    ...
    try:
        ...
        send_email(
            ...
            subject="Goo Buddy SMTP Test",
            body_text="This is a test email from Goo Buddy. If you received this, your SMTP settings are working correctly!",
            body_html="<p>This is a test email from <strong>Goo Buddy</strong>.</p><p>If you received this, your SMTP settings are working correctly!</p>",
        )
