...
<html>
<head>
    <title>Goo Buddy - Setup Required</title>
    <style>
        body {{
...
<body>
    <div class="container">
        ...
        <p class="note">After installing, restart Goo Buddy (the compatibility-preserved <code>bambuddy</code> service):<br>
...
logging.info("Goo Buddy starting - debug=%s, log_level=%s", app_settings.debug, log_level_str)
