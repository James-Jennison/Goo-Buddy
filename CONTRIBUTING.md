# Contributing to Goo Buddy

Thank you for your interest in contributing to Goo Buddy! This document provides guidelines and instructions for contributing.
...
Features and user-visible behavior changes **must** include matching updates to
repository-owned [Goo Buddy documentation](docs/). Do not imply that an upstream
site, demo, or documentation service is a Goo Buddy service.

### When documentation updates are required

| Change | Needs documentation? |
|---|---|
| New feature | ✅ |
...
1. Update the relevant file in `docs/`, `README.md`, or `install/` in the same change.
2. Link the documentation change in the pull request description.
3. Review rendered Markdown and referenced assets before requesting review.
...
Render or preview the changed repository Markdown and inspect linked assets before
opening a pull request. Catch broken links, layout regressions, typos, and missing
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/Goo-Buddy.git
   cd Goo-Buddy
   ```
...
Goo Buddy has an optional authentication system. When auth is enabled, API endpoints are protected by granular permissions.
...
Use the [Bug Report template](https://github.com/James-Jennison/Goo-Buddy/issues/new?template=bug_report.yml) and include:
...
Use the [Feature Request template](https://github.com/James-Jennison/Goo-Buddy/issues/new?template=feature_request.yml) and include:
...
- Check the [Documentation](https://github.com/James-Jennison/Goo-Buddy/tree/main/docs)
- Open a [Discussion](https://github.com/James-Jennison/Goo-Buddy/discussions)
- Review existing [Issues](https://github.com/James-Jennison/Goo-Buddy/issues)

---

Thank you for contributing to Goo Buddy!
