export default {
  ...
  nav: {
    ...
    installAppSuccess: 'Goo Buddy foi instalado',
  },
  ...
  printers: {
    ...
    maintenance: {
      ...
      editFieldHelp: 'Quando ativado, esta impressora é pausada do MQTT, despacho de fila e notificações — útil para reparos, instalações paralelas do Goo Buddy ou suspensão temporária.',
    },
    // Chamber light
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: 'Grupos LDAP são mapeados para grupos Goo Buddy no login',
      ...
      autoProvisionHint: 'Criar automaticamente uma conta Goo Buddy no primeiro login LDAP',
      ...
      groupMappingHint: 'Mapear DNs de grupos LDAP para grupos Goo Buddy. Grupos disponíveis: ',
    ...
    concurrentUploadsDescription: 'Quantas impressoras a fila pode abastecer com arquivos ao mesmo tempo. As impressoras recebem os arquivos lentamente (uma impressão grande pode levar vários minutos) e cada uma espera sua vez — portanto, em um parque maior, aumentar este valor evita que a última impressora de um lote tenha de esperar todas as transferências anteriores. Reduza-o se a sua rede ou o host do Goo Buddy tiver dificuldade com transferências paralelas.',
    ...
    preheatFilamentTargetsHint: 'Goo Buddy escolhe o alvo mais alto entre os slots AMS carregados; impressões apenas com PLA derivam 0 e pulam a fase da câmara automaticamente.',
    ...
    authDisabledMessage: 'Ative a autenticação para criar contas de usuário, gerenciar permissões e proteger sua instância do Goo Buddy.',
    ...
    disableAuthenticationMessage: 'Tem certeza de que deseja desativar a autenticação? Isso tornará sua instância do Goo Buddy acessível sem login. Todos os usuários permanecerão no banco de dados, mas a autenticação será desativada.',
    ...
    captureFinishPhotoDescription: 'Tirar foto da câmera da impressora quando a impressão for concluída. Goo Buddy grava um timelapse curto durante a impressão para que a foto possa ser obtida do momento antes da mesa descer; o arquivo do timelapse é mantido se você habilitou o timelapse para esta impressão, caso contrário ele é excluído automaticamente após a captura da foto.',
    ...
    bambuddySoftware: 'Software Goo Buddy',
    ...
    updateViaHomeAssistant: 'As atualizações são gerenciadas pelo Supervisor do Home Assistant. Abra Configurações → Complementos → Goo Buddy no Home Assistant para instalar a nova versão.',
    ...
    externalUrlDescription: 'A URL externa onde o Goo Buddy está acessível. Usada para imagens de notificação e integrações externas.',
    bambuddyUrl: 'URL do Goo Buddy',
    ...
    mqttDescription: 'Publique eventos do Goo Buddy para um broker MQTT externo para integração com Node-RED, Home Assistant e outros sistemas de automação.',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'Os segredos TOTP e client_secrets OIDC são armazenados em texto plano. Defina MFA_ENCRYPTION_KEY ou reinicie o Goo Buddy com um diretório de dados gravável para gerar automaticamente.',
      ...
      migrationErrorWarning: '{{count}} linha(s) antiga(s) não puderam ser recriptografadas na inicialização. Verifique os logs do servidor e reinicie o Goo Buddy para tentar novamente.',
    },
  ...
  hmsErrors: {
    ...
    runoutSlotUnknown: 'O filamento acabou e a impressão está pausada. O Goo Buddy não conseguiu determinar qual slot a impressora agora espera — verifique a tela da impressora para o slot solicitado.',
    actions: {
  ...
  login: {
    ...
    resetStep1: 'Entre em contato com o administrador do Goo Buddy',
    ...
    twoFA: {
      ...
      instructionsTotp: 'Abra seu aplicativo autenticador e insira o código de 6 dígitos gerado para o Goo Buddy.',
  ...
  // Setup page
  setup: {
    title: 'Goo Buddy Configuração',
    subtitle: 'Configure a autenticação para sua instância do Goo Buddy',
  ...
  users: {
    ...
    subtitle: 'Gerenciar usuários e seu acesso à sua instância do Goo Buddy',
    backToSettings: 'Voltar para Configurações',
    createUser: 'Criar Usuário',
    noPermission: 'Você não tem permissão para acessar esta página.',
    admin: 'Administrador',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: 'Entre na sua conta Orca Cloud para sincronizar seus perfis de slicer no Goo Buddy.',
      },
      device: {
        title: 'Aprovar o Goo Buddy no Orca Cloud',
        instruction: 'Abra o Orca Cloud e aprove este código. O Goo Buddy se conecta automaticamente assim que você aprovar.',
  ...
  sponsors: {
    ...
    tagline: 'O Goo Buddy é gratuito e continua assim porque há quem escolha apoiá-lo. Sem VC, sem dependência de nuvem.',
    viewSupporters: 'Ver apoiadores',
    toastPrints: 'Você concluiu {{count}} impressões com o Goo Buddy. O Goo Buddy continua gratuito graças a quem o apoia.',
    toastCost: 'Você acompanhou {{total}} de filamento com o Goo Buddy. Veja quem mantém o projeto independente.',
    toastArchives: '{{count}} impressões arquivadas com o Goo Buddy. Veja quem o mantém independente.',
    toastAnniversary: 'Um ano com o Goo Buddy! Veja quem mantém o projeto independente.',
    toastVersionUpdate: 'Atualizado para v{{version}}. O Goo Buddy continua gratuito graças a quem o apoia.',
    toastBusiness: 'Você usa o Goo Buddy em {{count}} impressoras? Existe um plano de suporte para equipes: correções prioritárias, emissão de nota fiscal e contato direto com o mantenedor.',
  ...
  inventory: {
    ...
    spoolmanMixedContentBody: 'O Goo Buddy é servido via HTTPS (pelo seu reverse proxy), mas a URL do Spoolman ainda é HTTP. Os navegadores bloqueiam conteúdo misto por segurança, então a interface embutida do Spoolman não consegue carregar. O Spoolman também precisa estar acessível via HTTPS.',
    spoolmanMixedContentFixReverseProxy: 'Coloque o Spoolman atrás do mesmo reverse proxy do Goo Buddy (Traefik / Nginx / Caddy) com HTTPS e atualize a URL do Spoolman em Configurações com o novo endereço HTTPS.',
  ...
  backup: {
    ...
    repoIsPublicWarning: 'O repositório está PÚBLICO. Os backups do Goo Buddy incluem credenciais MQTT, tokens do Home Assistant, tokens do Prometheus, seu e-mail do Bambu Cloud e os códigos de acesso das impressoras via K-profiles. Salvar está bloqueado até que você torne o repositório privado nas configurações do seu provedor.',
    repoVisibilityUnknown: 'Não foi possível determinar a visibilidade do repositório. O Goo Buddy se recusa a fazer backup em qualquer destino não confirmado como privado; salvar será bloqueado.',
    ...
    appSettingsDescription: 'Configuração do Goo Buddy (banco de dados completo)',
    ...
    localBackupDescription: 'Crie um backup completo dos seus dados do Goo Buddy incluindo banco de dados, arquivos, uploads e todos os ficheiros.',
    ...
    backupRestoredRestart: 'Backup restaurado. Por favor, reinicie o Goo Buddy.',
    ...
    pathCheck: {
      title: 'O Goo Buddy não consegue gravar neste diretório',
      howToFix: 'Como corrigir:',
      sandboxed: 'O serviço do Goo Buddy não consegue gravar em {{path}}. Sua unit do systemd roda com ProtectSystem=strict, o que torna todo diretório fora dos diretórios de instalação, dados e logs somente leitura para o serviço - mesmo um em que você consegue gravar pelo seu próprio shell.',
      read_only: '{{path}} está em um sistema de arquivos somente leitura.',
      permission_denied: 'O Goo Buddy não tem permissão para gravar em {{path}}. Verifique o dono e as permissões do diretório.',
      ...
      error: 'O Goo Buddy não consegue gravar em {{path}}.',
      ephemeralTitle: 'Estes backups não sobrevivem à recriação do contêiner',
      container_ephemeral: '{{path}} está dentro do contêiner do Goo Buddy, não no host. Backups gravados ali são perdidos quando o contêiner é recriado. Monte o diretório do host:',
    },
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'As notas são salvas no Goo Buddy, não na impressora',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Visível como "Goo Buddy" na descoberta do slicer',
    ...
    remoteInterface: {
      ...
      hint: 'Substitua o endereço IP anunciado via SSDP e usado no certificado TLS. Útil quando o Goo Buddy possui várias interfaces de rede.',
    },
    mode: {
      title: 'Modo',
      archive: 'Arquivar',
    ...
    caCert: {
      ...
      description: 'As impressoras virtuais usam um certificado TLS assinado pela CA do Goo Buddy. Importe este certificado CA para o armazenamento de confiança do seu slicer uma única vez para que ele aceite a conexão — sem precisar copiá-lo pela linha de comando.',
      copy: 'Copiar',
      copied: 'Copiado',
      download: 'Baixar',
      fingerprint: 'SHA-256',
  ...
  externalLinks: {
    ...
    systemPages: 'Páginas do Goo Buddy',
  ...
  spoolbuddy: {
    ...
    settings: {
      ...
      backendUrl: 'URL do backend Goo Buddy',
  ...
  diagnostic: {
    ...
    check: {
      ...
      network_mode: {
        ...
        warn: 'O Goo Buddy está sendo executado em rede Docker bridge. A descoberta de impressoras e a impressora virtual precisam do modo de rede host — recrie o contêiner com "network_mode: host".',
        skip: 'Não está sendo executado no Docker — não aplicável.',
      },
      subnet: {
        title: 'Sub-rede',
        pass: 'A impressora e o Goo Buddy estão na mesma sub-rede.',
        warn: 'A impressora ({{printer_ip}}) e o Goo Buddy ({{host_ip}}) estão em sub-redes diferentes. Eles podem não se alcançar, a menos que o roteamento entre as sub-redes esteja configurado.',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Copie novamente o código de acesso da tela da impressora (configurações de LAN) e atualize-o nas configurações da impressora no Goo Buddy.',
      },
      'ftp-connection-timeout': {
        name: 'Tempo limite da conexão de transferência de arquivos',
        cause: 'O Goo Buddy não conseguiu acessar a porta de transferência de arquivos da impressora (FTPS 990). A porta está bloqueada, ou a impressora está desligada ou em outra sub-rede.',
        fix: 'Verifique se nada bloqueia a porta 990 entre o Goo Buddy e a impressora e se ambos estão na mesma rede.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Migre o Goo Buddy para um banco de dados PostgreSQL externo. Consulte o guia do PostgreSQL na documentação.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'A impressora virtual está habilitada, mas seus serviços não estão em execução. Verifique o log do Goo Buddy — geralmente um conflito de IP de vínculo ou um erro de permissão os interrompe.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        pass: 'Certificado pronto. Verifique se o certificado CA do Goo Buddy (acima) está importado no armazenamento de confiança do seu slicer.',
        fail: 'O certificado TLS desta impressora virtual está ausente. Verifique se o diretório de dados do Goo Buddy tem permissão de escrita.',
      },
    },
  },
  ...
  failureDetection: {
    ...
    externalUrlHint: 'A API ML busca a captura da câmera por URL. Defina a URL externa nas configurações gerais para que o contêiner da API ML possa alcançar o Goo Buddy.',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'Cole uma URL de modelo do MakerWorld para importar e imprimir diretamente do Goo Buddy — sem precisar abrir o app Bambu Handy.',
    ...
    signInExpiredTitle: 'Sessão do Bambu Cloud expirada',
    signInExpiredBody: 'Você continua conectado ao Goo Buddy, mas a Bambu Lab deixou de aceitar o token armazenado, então os downloads vão falhar. Entre novamente no Bambu Cloud.',
    ...
    disclaimer: 'A integração com o MakerWorld usa endpoints de API documentados pela comunidade. Goo Buddy não é afiliado nem endossado pelo MakerWorld ou pela Bambu Lab.',
  ...
  libraryPurge: {
    ...
    effect4: 'Arquivos em pastas externas (vinculadas) são ignorados — Goo Buddy nunca exclui bytes que não possui.',    previewLoading: 'Verificando quantos arquivos correspondem…',
