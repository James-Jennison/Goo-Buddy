export default {
  ...
  nav: {
    ...
    installAppSuccess: 'Goo Buddy a été installé',
  },
  ...
  printers: {
    ...
    maintenance: {
      ...
      editFieldHelp: "Quand activé, cette imprimante est mise en pause de MQTT, de la file d'attente et des notifications — utile pour les réparations, les installations Goo Buddy parallèles ou une suspension temporaire.",
    },
    // Chamber light
  ...
  archives: {
    ...
    no3mfBanner: {
      ...
      body: 'Le slicer n\'a pas laissé le fichier .gcode.3mf sur la carte SD de l\'imprimante, donc Goo Buddy n\'a pas pu récupérer la miniature ni les métadonnées slicer. C\'est généralement parce que « Stocker les fichiers envoyés sur stockage externe » est désactivé dans le slicer (onglet Périphérique de Bambu Studio / OrcaSlicer).',
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: 'Les groupes LDAP sont associés aux groupes Goo Buddy à la connexion',
      ...
      autoProvisionHint: 'Créer automatiquement un compte Goo Buddy lors de la première connexion LDAP',
      ...
      groupMappingHint: 'Associer les DN de groupes LDAP aux groupes Goo Buddy. Groupes disponibles : ',
    ...
    concurrentUploadsDescription: "Nombre d'imprimantes auxquelles la file d'attente peut envoyer des fichiers en même temps. Les imprimantes reçoivent les fichiers lentement (une grosse impression peut prendre plusieurs minutes) et chacune attend son tour : sur un parc important, augmenter cette valeur évite que la dernière imprimante d'un lot doive attendre la fin de tous les transferts précédents. Réduisez-la si votre réseau ou votre hôte Goo Buddy supporte mal les transferts parallèles.",
    ...
    preheatFilamentTargetsHint: 'Goo Buddy choisit la cible la plus haute parmi les slots AMS chargés ; les impressions PLA uniquement dérivent 0 et sautent la phase chambre automatiquement.',
    ...
    // Additional settings
    configureBambuddy: 'Configurer Goo Buddy',
    ...
    bambuddySoftware: 'Logiciel Goo Buddy',
    ...
    updateViaHomeAssistant: 'Les mises à jour sont gérées par le superviseur Home Assistant. Ouvrez Paramètres → Modules complémentaires → Goo Buddy dans Home Assistant pour installer la nouvelle version.',
    ...
    externalUrlDescription: 'L\'URL externe où Goo Buddy est accessible. Utilisée pour les images de notification et les intégrations externes.',
    bambuddyUrl: 'URL Goo Buddy',
    ...
    mqttDescription: 'Publier les événements Goo Buddy vers un broker MQTT externe pour l\'intégration avec Node-RED, Home Assistant et d\'autres systèmes d\'automatisation.',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'Les secrets TOTP et client_secrets OIDC sont stockés en clair. Définissez MFA_ENCRYPTION_KEY ou redémarrez Goo Buddy avec un répertoire de données accessible en écriture pour en générer un automatiquement.',
      ...
      migrationErrorWarning: "{{count}} ligne(s) ancienne(s) n'ont pas pu être rechiffrée(s) au démarrage. Vérifiez les journaux du serveur et redémarrez Goo Buddy pour réessayer.",
    },
  ...
  hmsErrors: {
    ...
    runoutSlotUnknown: 'Le filament est épuisé et l\'impression est en pause. Goo Buddy n\'a pas pu déterminer quel emplacement l\'imprimante attend désormais — vérifiez l\'écran de l\'imprimante pour l\'emplacement demandé.',
    actions: {
  ...
  login: {
    ...
    resetStep1: 'Contactez votre admin Goo Buddy',
    ...
    twoFA: {
      ...
      instructionsTotp: "Ouvrez votre application d'authentification et saisissez le code à 6 chiffres pour Goo Buddy.",
  ...
  users: {
    ...
    subtitle: 'Gérez les accès à Goo Buddy',
    backToSettings: 'Retour aux paramètres',
    createUser: 'Créer un utilisateur',
    noPermission: 'Accès refusé.',
    admin: 'Administrateur',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: 'Connectez-vous à votre compte Orca Cloud pour synchroniser vos profils de slicer dans Goo Buddy.',
      },
      device: {
        title: 'Approuver Goo Buddy dans Orca Cloud',
        instruction: 'Ouvrez Orca Cloud et approuvez ce code. Goo Buddy se connecte automatiquement dès que vous l\'approuvez.',
  ...
  sponsors: {
    ...
    tagline: 'Goo Buddy est gratuit et le reste parce que des personnes choisissent de le soutenir. Pas de VC, pas de verrouillage cloud.',
    viewSupporters: 'Voir les soutiens',
    toastPrints: 'Tu as terminé {{count}} impressions avec Goo Buddy. Goo Buddy reste gratuit grâce à ceux qui le soutiennent.',
    toastCost: 'Tu as suivi {{total}} de filament avec Goo Buddy. Vois qui garde le projet indépendant.',
    toastArchives: '{{count}} impressions archivées avec Goo Buddy. Vois qui le garde indépendant.',
    toastAnniversary: 'Un an avec Goo Buddy ! Vois qui garde le projet indépendant.',
    toastVersionUpdate: 'Mis à jour vers v{{version}}. Goo Buddy reste gratuit grâce à ceux qui le soutiennent.',
    toastBusiness: "Vous utilisez Goo Buddy sur {{count}} imprimantes ? Il existe une offre de support pour les équipes : corrections prioritaires, facturation et contact direct avec le mainteneur.",
    businessCta: "Goo Buddy pour les entreprises",
    businessTitle: "Goo Buddy pour les entreprises",
  ...
  inventory: {
    ...
    spoolmanMixedContentBody: 'Goo Buddy est servi en HTTPS (via votre reverse proxy), mais votre URL Spoolman est encore en HTTP. Les navigateurs bloquent le contenu mixte pour des raisons de sécurité, donc l\'interface Spoolman intégrée ne peut pas s\'afficher. Spoolman doit être accessible en HTTPS.',
    spoolmanMixedContentFixReverseProxy: 'Placez Spoolman derrière le même reverse proxy que Goo Buddy (Traefik / Nginx / Caddy) en HTTPS, puis mettez à jour l\'URL Spoolman dans les Paramètres avec la nouvelle adresse HTTPS.',
  ...
  backup: {
    ...
    repoIsPublicWarning: 'Le dépôt est PUBLIC. Les sauvegardes Goo Buddy contiennent les identifiants MQTT, les jetons Home Assistant, les jetons Prometheus, votre adresse Bambu Cloud, et les codes d\'accès des imprimantes via les K-profils. L\'enregistrement est bloqué tant que le dépôt n\'est pas passé en privé dans les paramètres de votre hébergeur.',
    repoVisibilityUnknown: 'Impossible de déterminer la visibilité du dépôt. Goo Buddy refuse toute sauvegarde vers un dépôt non confirmé privé ; l\'enregistrement sera bloqué.',
    ...
    appSettingsDescription: 'Configuration Goo Buddy (base de données complète)',
    ...
    localBackupDescription: 'Créez une sauvegarde complète de vos données Goo Buddy incluant la base de données, les archives, les téléchargements et tous les fichiers.',
    ...
    backupRestoredRestart: 'Sauvegarde restaurée. Veuillez redémarrer Goo Buddy.',
    ...
    pathCheck: {
      ...
      error: 'Goo Buddy ne peut pas écrire dans {{path}}.',
      ephemeralTitle: 'Ces sauvegardes ne survivront pas à la recréation du conteneur',
      container_ephemeral: '{{path}} se trouve dans le conteneur Goo Buddy, pas sur l\'hôte. Les sauvegardes qui y sont écrites sont perdues à la recréation du conteneur. Montez le répertoire depuis l\'hôte :',
    },
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'Enregistré dans Goo Buddy, pas sur l\'imprimante',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Visible comme "Goo Buddy" dans le Slicer',
    ...
    howItWorks: {
      ...
      step2: 'En mode Archive, Revue et File d\'attente, utilisez le bouton "Envoyer" dans votre slicer pour envoyer des fichiers 3MF à Goo Buddy. Le slicer affichera "Impression réussie" — le fichier est stocké, pas imprimé.',
    ...
    caCert: {
      ...
      description: 'Les imprimantes virtuelles utilisent un certificat TLS signé par l\'autorité de certification Goo Buddy. Importez ce certificat CA dans le magasin de confiance de votre slicer une seule fois pour qu\'il accepte la connexion — plus besoin de le copier depuis la ligne de commande.',
      copy: 'Copier',
      copied: 'Copié',
      download: 'Télécharger',
      fingerprint: 'SHA-256',
  ...
  smartPlugs: {
    ...
    restEnergyTotalHint:
      "Beaucoup de prises — tous les Shelly notamment — ne fournissent qu'un compteur cumulé qui ne se remet jamais à zéro. Il va ici, pas dans le champ ci-dessus : lu comme la consommation du jour, il ne repartirait jamais de zéro à minuit, et Hier et Total resteraient vides. Goo Buddy en déduit Aujourd'hui et Hier, ce qui demande un à deux jours de relevés. Un Shelly renvoie des wattheures : utilisez un multiplicateur de 0.001.",
  ...
  spoolbuddy: {
    ...
    settings: {
      ...
      backendUrl: 'URL du backend Goo Buddy',
  ...
  diagnostic: {
    ...
    check: {
      ...
      network_mode: {
        ...
        warn: 'Goo Buddy fonctionne en réseau Docker bridge. La découverte d\'imprimantes et l\'imprimante virtuelle nécessitent le mode réseau host — recréez le conteneur avec "network_mode: host".',
        skip: 'Ne fonctionne pas dans Docker — non applicable.',
      },
      subnet: {
        title: 'Sous-réseau',
        pass: 'L\'imprimante et Goo Buddy sont sur le même sous-réseau.',
        warn: 'L\'imprimante ({{printer_ip}}) et Goo Buddy ({{host_ip}}) sont sur des sous-réseaux différents. Ils peuvent ne pas se joindre, sauf si un routage entre les sous-réseaux est configuré.',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Recopiez le code d\'accès depuis l\'écran de l\'imprimante (paramètres LAN) et mettez-le à jour dans les paramètres de l\'imprimante dans Goo Buddy.',
      },
      'ftp-connection-timeout': {
        name: 'Délai de connexion de transfert de fichiers dépassé',
        cause: 'Goo Buddy n\'a pas pu atteindre le port de transfert de fichiers de l\'imprimante (FTPS 990). Le port est bloqué, ou l\'imprimante est éteinte ou sur un autre sous-réseau.',
        fix: 'Assurez-vous que rien ne bloque le port 990 entre Goo Buddy et l\'imprimante, et que les deux sont sur le même réseau.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Faites passer Goo Buddy à une base de données PostgreSQL externe. Consultez le guide PostgreSQL dans la documentation.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'L\'imprimante virtuelle est activée mais ses services ne sont pas en cours d\'exécution. Consultez le journal Goo Buddy — un conflit d\'IP de liaison ou une erreur de permission les arrête généralement.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        pass: 'Certificat prêt. Assurez-vous que le certificat CA Goo Buddy (ci-dessus) est importé dans le magasin de confiance de votre slicer.',
        fail: 'Le certificat TLS de cette imprimante virtuelle est manquant. Vérifiez que le répertoire de données Goo Buddy est accessible en écriture.',
      },
    },
  },
  ...
  failureDetection: {
    ...
    externalUrlHint: 'L\'API ML récupère la capture caméra par URL. Définissez l\'URL externe dans les paramètres généraux pour que le conteneur API ML puisse atteindre Goo Buddy.',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'Collez une URL de modèle MakerWorld pour l\'importer et l\'imprimer directement depuis Goo Buddy — sans passer par l\'application Bambu Handy.',
    ...
    signInExpiredTitle: 'Session Bambu Cloud expirée',
    signInExpiredBody: 'Vous êtes toujours connecté à Goo Buddy, mais Bambu Lab n\'accepte plus le jeton enregistré : les téléchargements échoueront. Reconnectez-vous à Bambu Cloud.',
    ...
    disclaimer: 'L\'intégration MakerWorld utilise des points de terminaison API documentés par la communauté. Goo Buddy n\'est ni affilié ni approuvé par MakerWorld ou Bambu Lab.',
  ...
  libraryPurge: {
    ...
    effect4: 'Les fichiers dans les dossiers externes (liés) sont ignorés — Goo Buddy ne supprime jamais d\'octets qu\'il ne possède pas.',    previewLoading: 'Vérification du nombre de fichiers concernés…',
