export default {
  ...
  nav: {
    ...
    installAppSuccess: 'Goo Buddy è stato installato',
  },
  ...
  printers: {
    ...
    maintenance: {
      ...
      editFieldHelp: 'Quando attivata, questa stampante è in pausa da MQTT, dispatch della coda e notifiche — utile per riparazioni, installazioni Goo Buddy parallele o sospensione temporanea.',
    },
    // Chamber light
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: 'I gruppi LDAP vengono mappati ai gruppi Goo Buddy al login',
      ...
      autoProvisionHint: 'Crea automaticamente un account Goo Buddy al primo accesso LDAP',
      ...
      groupMappingHint: 'Mappa i DN dei gruppi LDAP ai gruppi Goo Buddy. Gruppi disponibili: ',
    ...
    preheatFilamentTargetsHint: 'Goo Buddy sceglie il target più alto tra gli slot AMS caricati; le stampe solo PLA derivano 0 e saltano la fase camera automaticamente.',
    ...
    authDisabledMessage: 'Abilita autenticazione per creare account, gestire permessi e proteggere la tua istanza Goo Buddy.',
    ...
    disableAuthenticationMessage: 'Sei sicuro di voler disabilitare l\'autenticazione? Questo renderà la tua istanza Goo Buddy accessibile senza login. Tutti gli utenti resteranno nel database ma l\'autenticazione sarà disabilitata.',
    disableAuthentication: 'Disabilita autenticazione',
    // Additional settings
    configureBambuddy: 'Configura Goo Buddy',
    ...
    updateViaHomeAssistant: 'Gli aggiornamenti sono gestiti dal Supervisor di Home Assistant. Apri Impostazioni → Add-on → Goo Buddy in Home Assistant per installare la nuova versione.',
    ...
    externalUrlDescription: 'L\'URL esterno dove Goo Buddy è accessibile. Usato per immagini di notifica e integrazioni esterne.',
    ...
    mqttDescription: 'Pubblica eventi Goo Buddy su un broker MQTT esterno per l\'integrazione con Node-RED, Home Assistant e altri sistemi di automazione.',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'I segreti TOTP e i client_secrets OIDC sono memorizzati in chiaro. Imposta MFA_ENCRYPTION_KEY o riavvia Goo Buddy con una directory dati scrivibile per generarne uno automaticamente.',
      ...
      migrationErrorWarning: "{{count}} riga/righe legacy non sono state ricifrate all'avvio. Controlla i log del server e riavvia Goo Buddy per riprovare.",
    },
  ...
  hmsErrors: {
    ...
    runoutSlotUnknown: 'Il filamento è esaurito e la stampa è in pausa. Goo Buddy non è riuscito a determinare quale slot la stampante attende ora — controlla lo schermo della stampante per lo slot richiesto.',
    actions: {
  ...
  login: {
    ...
    resetStep1: 'Contatta il tuo amministratore Goo Buddy',
    ...
    twoFA: {
      ...
      instructionsTotp: "Apri la tua app di autenticazione e inserisci il codice a 6 cifre per Goo Buddy.",
  ...
  // Setup page
  setup: {
    title: 'Configurazione Goo Buddy',
    subtitle: 'Configura autenticazione per la tua istanza Goo Buddy',
  ...
  users: {
    ...
    subtitle: 'Gestisci utenti e accesso alla tua istanza Goo Buddy',
    backToSettings: 'Torna a Impostazioni',
    createUser: 'Crea utente',
    noPermission: 'Non hai il permesso di accedere a questa pagina.',
    admin: 'Amministratore',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: 'Accedi al tuo account Orca Cloud per sincronizzare i profili dello slicer in Goo Buddy.',
      },
      device: {
        title: 'Approva Goo Buddy in Orca Cloud',
        instruction: 'Apri Orca Cloud e approva questo codice. Goo Buddy si connette automaticamente non appena approvi.',
  ...
  sponsors: {
    ...
    tagline: 'Goo Buddy è gratuito e resta tale perché qualcuno sceglie di sostenerlo. Niente VC, niente lock-in cloud.',
    viewSupporters: 'Vedi i sostenitori',
    toastPrints: 'Hai completato {{count}} stampe con Goo Buddy. Goo Buddy resta gratuito grazie a chi lo sostiene.',
    toastCost: 'Hai monitorato {{total}} di filamento con Goo Buddy. Scopri chi mantiene il progetto indipendente.',
  ...
  inventory: {
    ...
    spoolmanMixedContentBody: 'Goo Buddy viene servito tramite HTTPS (dietro il tuo reverse proxy), ma l\'URL di Spoolman è ancora HTTP. I browser bloccano il contenuto misto per motivi di sicurezza, quindi l\'interfaccia Spoolman incorporata non può essere visualizzata. Anche Spoolman deve essere raggiungibile via HTTPS.',
    spoolmanMixedContentFixReverseProxy: 'Metti Spoolman dietro lo stesso reverse proxy di Goo Buddy (Traefik / Nginx / Caddy) in HTTPS, poi aggiorna l\'URL di Spoolman nelle Impostazioni con il nuovo indirizzo HTTPS.',
  ...
  backup: {
    ...
    repoIsPublicWarning: 'Il repository è PUBBLICO. I backup di Goo Buddy includono credenziali MQTT, token di Home Assistant, token di Prometheus, la tua e-mail Bambu Cloud e i codici di accesso alle stampanti tramite K-profile. Il salvataggio è bloccato finché non rendi privato il repository nelle impostazioni del tuo provider.',
    repoVisibilityUnknown: 'Impossibile determinare la visibilità del repository. Goo Buddy rifiuta di eseguire backup su qualsiasi target non confermato come privato; il salvataggio sarà bloccato.',
    ...
    appSettingsDescription: 'Configurazione Goo Buddy (database completo)',
    ...
    localBackupDescription: 'Crea un backup completo dei tuoi dati Goo Buddy includendo database, archivi, upload e tutti i file.',
    ...
    backupRestoredRestart: 'Backup ripristinato. Riavvia Goo Buddy.',
    ...
    pathCheck: {
      title: 'Goo Buddy non riesce a scrivere in questa directory',
      howToFix: 'Come risolvere:',
      sandboxed: 'Il servizio Goo Buddy non riesce a scrivere in {{path}}. La sua unit systemd usa ProtectSystem=strict, che rende ogni directory al di fuori di quelle di installazione, dati e log di sola lettura per il servizio - anche una in cui puoi scrivere dalla tua shell.',
      read_only: '{{path}} si trova su un filesystem di sola lettura.',
      permission_denied: 'Goo Buddy non ha il permesso di scrivere in {{path}}. Controlla proprietario e permessi della directory.',
      ...
      error: 'Goo Buddy non riesce a scrivere in {{path}}.',
      ephemeralTitle: 'Questi backup non sopravvivono alla ricreazione del container',
      container_ephemeral: '{{path}} si trova dentro il container Goo Buddy, non sull\'host. I backup scritti lì vanno persi quando il container viene ricreato. Monta la directory dall\'host:',
    },
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'Le note sono salvate in Goo Buddy, non sulla stampante',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Visibile come "Goo Buddy" nella ricerca slicer',
    ...
    remoteInterface: {
      ...
      hint: 'Sovrascrive l\'indirizzo IP pubblicizzato via SSDP e usato nel certificato TLS. Utile quando Goo Buddy ha piu interfacce di rete.',
    },
    mode: {
      title: 'Modalita',
      archive: 'Archivio',
    ...
    howItWorks: {
      ...
      step2: 'In modalità Archivio, Revisione e Coda, usa il pulsante "Invia" nel tuo slicer per caricare file 3MF su Goo Buddy. Lo slicer mostrerà "Stampa riuscita" — il file viene salvato, non stampato.',
    ...
    caCert: {
      ...
      description: 'Le stampanti virtuali usano un certificato TLS firmato dalla CA di Goo Buddy. Importa questo certificato CA nell\'archivio attendibile del tuo slicer una sola volta affinché accetti la connessione — senza doverlo copiare dalla riga di comando.',
      copy: 'Copia',
      copied: 'Copiato',
      download: 'Scarica',
      fingerprint: 'SHA-256',
  ...
  spoolbuddy: {
    ...
    settings: {
      ...
      backendUrl: 'URL backend Goo Buddy',
      apiToken: 'Token API',
  ...
  diagnostic: {
    ...
    check: {
      ...
      network_mode: {
        ...
        warn: 'Goo Buddy è in esecuzione con la rete Docker bridge. Il rilevamento delle stampanti e la stampante virtuale richiedono la modalità di rete host — ricrea il container con "network_mode: host".',
        skip: 'Non in esecuzione in Docker — non applicabile.',
      },
      subnet: {
        title: 'Sottorete',
        pass: 'La stampante e Goo Buddy sono nella stessa sottorete.',
        warn: 'La stampante ({{printer_ip}}) e Goo Buddy ({{host_ip}}) sono in sottoreti diverse. Potrebbero non raggiungersi a meno che non sia configurato il routing tra le sottoreti.',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Ricopia il codice di accesso dallo schermo della stampante (impostazioni LAN) e aggiornalo nelle impostazioni della stampante in Goo Buddy.',
      },
      'ftp-connection-timeout': {
        name: 'Timeout della connessione di trasferimento file',
        cause: 'Goo Buddy non è riuscito a raggiungere la porta di trasferimento file della stampante (FTPS 990). La porta è bloccata, oppure la stampante è spenta o in un\'altra sottorete.',
        fix: 'Assicurati che nulla blocchi la porta 990 tra Goo Buddy e la stampante e che entrambi siano sulla stessa rete.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Passa Goo Buddy a un database PostgreSQL esterno. Consulta la guida PostgreSQL nella documentazione.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'La stampante virtuale è abilitata ma i suoi servizi non sono in esecuzione. Controlla il log di Goo Buddy — di solito li ferma un conflitto di IP di binding o un errore di permessi.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        pass: 'Certificato pronto. Assicurati che il certificato CA di Goo Buddy (sopra) sia importato nell\'archivio attendibile del tuo slicer.',
        fail: 'Il certificato TLS per questa stampante virtuale è mancante. Verifica che la directory dei dati di Goo Buddy sia scrivibile.',
      },
    },
  },
  ...
  failureDetection: {
    ...
    externalUrlHint: 'L\'API ML recupera l\'istantanea della telecamera tramite URL. Imposta l\'URL esterno nelle impostazioni generali in modo che il container API ML possa raggiungere Goo Buddy.',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'Incolla un URL di un modello MakerWorld per importarlo e stamparlo direttamente da Goo Buddy — senza passare dall\'app Bambu Handy.',
    ...
    signInExpiredTitle: 'Accesso a Bambu Cloud scaduto',
    signInExpiredBody: 'Hai ancora effettuato l\'accesso a Goo Buddy, ma Bambu Lab non accetta più il token salvato, quindi i download non riusciranno. Accedi di nuovo a Bambu Cloud.',
    ...
    disclaimer: 'L\'integrazione MakerWorld utilizza endpoint API documentati dalla community. Goo Buddy non è affiliato né approvato da MakerWorld o Bambu Lab.',
  ...
  libraryPurge: {
    ...
    effect4: 'I file in cartelle esterne (collegate) vengono saltati — Goo Buddy non elimina mai dati che non possiede.',    previewLoading: 'Verifica quanti file corrispondono…',
