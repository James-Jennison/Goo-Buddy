              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-green-700 dark:text-green-300 space-y-1 list-disc list-inside">
                    ...
                    <li>{t('settings.ldap.feature3') || 'LDAP groups are mapped to Goo Buddy groups on login'}</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            >
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-bambu-gray mt-0.5">
                      {t('settings.ldap.autoProvisionHint') || 'Automatically create a Goo Buddy account on first LDAP login'}
                    </p>
                  </div>
                  <button
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-bambu-gray mt-1">
                    {t('settings.ldap.groupMappingHint') || 'Map LDAP group DNs to Goo Buddy groups. Available groups: '}{groups.map(g => g.name).join(', ')}
                  </p>
                </div>
              </div>
            </Collapsible>
