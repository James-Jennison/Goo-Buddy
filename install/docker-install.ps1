<#
.SYNOPSIS
    Goo Buddy Docker installation script for Windows (Docker Desktop).
...
function Write-Banner {
    ...
    Write-Host '   Goo Buddy - Docker Installation (Windows)' -ForegroundColor Cyan
    Write-Host '==========================================================' -ForegroundColor Cyan
    Write-Host ''
}
...
function Get-ComposeFile {
    ...
    if ($Build) {
        ...
        Invoke-WebRequest `
            -Uri 'https://raw.githubusercontent.com/James-Jennison/Goo-Buddy/main/docker-compose.yml' `
...
function Start-Bambuddy {
    Info 'Starting Goo Buddy container...'
    if ($Build) {
    ...
    while ($attempts -lt 15) {
        ...
        if ($ps -match 'Up') { Ok 'Goo Buddy container is running'; return }
        if ($ps -match 'Exited') {
...
Write-Host '==========================================================' -ForegroundColor Green
Write-Host ''
Write-Host "  Access Goo Buddy:  http://localhost:$Port" -ForegroundColor Cyan
...
Write-Host ''
Write-Host '  Documentation:    https://github.com/James-Jennison/Goo-Buddy#readme' -ForegroundColor Cyan
Write-Host ''
