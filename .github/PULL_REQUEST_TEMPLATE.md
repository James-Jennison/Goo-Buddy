...
**Companion docs updates** (delete lines that don't apply):
- Goo Buddy repository docs: docs/___
- Upstream documentation reference (only when relevant): maziggy/bambuddy-wiki#___
